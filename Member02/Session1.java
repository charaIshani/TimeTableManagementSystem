...
public class Session1 {
	...
	private void initialize() {
		...
		frame.getContentPane().add(table);
		 ...
		 comboLecturer.setModel(new DefaultComboBoxModel(new String[] {""}));
		...
		btnNext.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\next-button.png"));
		...
		btnManageSessions.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\previous.png"));
