...
public class Employee {
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\GenerateID1.png"));
//		btnNewButton.setIcon(new ImageIcon(this.getClass().getResource("/GenerateID1.png")));
		...
		btnSave.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\add.png"));
...
//    					Connection con = DBConnect.connect();
		...
		btnClear.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\clear4.png"));
