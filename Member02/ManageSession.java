...
public class ManageSession {
	...
	private void initialize() {
		...
		btnAddSession.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\next-button.png"));
		...
		btnRefresh.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\clear4.png"));
		...
		btnUpdate.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\update.png"));
...
//    					Connection con = DBConnect.connect();
		...
		btnDelete.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\remove.png"));
...
//						
//						String query1="select * from Session where SubjectCode=?";
//						PreparedStatement pst1=con1.prepareStatement(query1);
//						pst1.setString(3, txtSearchLect.getText());
...
//					}
		...
		comboLect2.setBounds(59, 366, 355, 22);
		...
		comboSubCode.setBounds(59, 414, 355, 22);
		...
		lblNewLabel_9.setBounds(59, 391, 111, 22);
		...
		btnNewButton.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\next-button.png"));
		...
		btnAddSessionRooms.setIcon(new ImageIcon("E:\\Y3S1\\ITPM\\finalTimeTableManagementSystem\\Images\\next-button.png"));
