...
public void fillComboBox3() {
	...
	try {
		  ...
		  String query ="select age from age";
		  PreparedStatement pst =conn.prepareStatement(query);
		  ResultSet rs = pst.executeQuery();
...
private void tableAction(){
   ...
   try {
	...
	private void initialize() {
		...
		comboBoxname.setBounds(72, 145, 287, 22);
		frame.getContentPane().add(comboBoxname);
		
	    comboBox2 = new JComboBox();
		comboBox2.setBounds(72, 217, 287, 22);
		frame.getContentPane().add(comboBox2);
		
	    comboBox3 = new JComboBox();
		comboBox3.setBounds(72, 286, 287, 22);
		frame.getContentPane().add(comboBox3);
		
		 comboBox4 = new JComboBox();
		comboBox4.setBounds(72, 362, 287, 22);
		frame.getContentPane().add(comboBox4);
		
		 comboBox5 = new JComboBox();
		comboBox5.setBounds(72, 420, 287, 22);
		frame.getContentPane().add(comboBox5);
		
		comboBox6 = new JComboBox();
		comboBox6.setBounds(72, 490, 287, 22);
		...
		update.setBounds(216, 665, 97, 32);
		...
		delete.setBounds(62, 665, 113, 32);
		frame.getContentPane().add(delete);
		
		JButton clear = new JButton("CLEAR");
		clear.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 14));
		...
		start.setBounds(69, 560, 113, 22);
		frame.getContentPane().add(start);
		start.setColumns(10);
		
		end = new JTextField();
		end.setBounds(227, 560, 113, 22);
		...
		lblNewLabel_10.setBounds(186, 562, 31, 14);
