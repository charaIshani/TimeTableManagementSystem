...
//				
		...
		btnNewButton.setIcon(new ImageIcon(this.getClass().getResource("/clear4.png")));
		...
		btnSubmit.setIcon(new ImageIcon(this.getClass().getResource("/add.png")));
		...
		btnBack.setIcon(new ImageIcon(this.getClass().getResource("/previous.png")));
